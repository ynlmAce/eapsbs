...
public class AuthController {
     ...
     */
    @PostMapping("/login")
    public ApiResponse<UserInfo> login(@Valid @RequestBody LoginRequest request) {
    ...
    public ApiResponse<Boolean> changePassword(@Valid @RequestBody ChangePasswordRequest request) {
        ...
        boolean success = userService.changePassword(request.getUserId(), request.getOldPassword(),
