          ...
          <div class="header-container">
            ...
            <div class="user-info">
              <el-dropdown>
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item @click="goToProfile">企业档案</el-dropdown-item>
...
import { OfficeBuilding, Briefcase, Files, ChatDotRound, ArrowDown } from '@element-plus/icons-vue'
...
// 从userStore获取用户信息
const userInfo = computed(() => userStore.userInfo || { name: '企业用户' })
