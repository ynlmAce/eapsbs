package com.employmentsupport.eaps.controller;

import com.employmentsupport.eaps.common.ApiResponse;
...
public class AuthController {
    ...
    public ApiResponse<Boolean> changePassword(
        ...
        boolean success = userService.changePassword(userInfo.getId(), oldPassword, newPassword);
        return ApiResponse.success(success);
    }
}