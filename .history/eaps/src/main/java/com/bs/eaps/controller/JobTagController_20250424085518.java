...
public class JobTagController {
     ...
     */
    @PostMapping("/list")
    public ApiResponse<List<JobTag>> getAllTags() {
     ...
     */
    @PostMapping("/detail")
    public ApiResponse<JobTag> getTagDetail(@RequestBody TagDetailRequest request) {
     ...
     */
    @PostMapping("/save")
    public ApiResponse<Boolean> saveOrUpdateTag(@RequestBody JobTag jobTag) {
     ...
     */
    @PostMapping("/remove")
    public ApiResponse<Boolean> removeTag(@RequestBody TagDetailRequest request) {
