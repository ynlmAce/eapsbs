...
// 导入API函数
import { getChatSessions, getChatMessages, sendChatMessage, markMessageRead, uploadChatFile, reportMessage } from '@/api/chat';
...
// 举报消息
const reportMessage = async (messageId, reason = '内容不当') => {
  try {
