 ...
 * @param {string} sessionData.type - 会话类型（SE: 学生-企业, SC: 学生-辅导员, SS: 学生群组）
 * @param {number} [sessionData.relatedJobId] - 关联岗位ID（学生-企业会话）
 * @param {number} [sessionData.groupId] - 关联群组ID（学生群组会话）
 * @param {number} sessionData.targetUserId - 目标用户ID（对方ID）
